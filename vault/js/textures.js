...
// The trading wall's screens used to be generated here as canvas textures.
// They are CSS3D/SVG now (js/screens.js): a texture minified into a couple
// hundred screen pixels, then resampled again by the renderer's DPR cap,
// cannot stay legible next to the board's real DOM text. Do not reintroduce
// them here — raising the resolution was already tried and is not the fix.
